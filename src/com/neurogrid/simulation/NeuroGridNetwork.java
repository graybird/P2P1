 ...
 *
 * This class implements a NeuroGrid Network.<br><br>
 *
 * Change History<br>
 * ------------------------------------------------------------------------------------<br>
...
public class NeuroGridNetwork extends Network
{
  // private variables
  private static final String cvsInfo = "$Id: NeuroGridNetwork.java,v 1.5 2003/06/25 11:50:46 samjoseph Exp $";
  public static String getCvsInfo()
  {
    return cvsInfo;
  }

  private static Category o_cat = Category.getInstance(NeuroGridNetwork.class.getName());  
  ...
  public static void init(String p_conf)
  {
    ...
    o_cat.info("NeuroGridNetwork logging Initialized");
  }
    ...
    throws Exception
  {
    ...
    {
      x_temp_node = new NeuroGridNode(this,
                                      p_random,
                                      o_max_connections_per_node,
                                      o_min_connections_per_node,
                                      o_max_knowledge_per_node);
   ...
   */
  public HashMap createNodes(int p_no_nodes, 
  ...
  {  
    ...
    {
      x_temp_node = new AdversarialNode(this,new NeuroGridMessageHandler(p_random));
      // however ideally in this case the Adversarial node would extend ResourceLimitedNode ---> need that as handler
      x_new_nodes.put(x_temp_node.getNodeID(),x_temp_node);
    }     
    
    if(o_cat.isDebugEnabled()) o_cat.debug("Created Nodes");
    if(o_cat.isInfoEnabled()) o_cat.info("o_max_connections_per_node: " + o_max_connections_per_node);
