 ...
 *
 * This class implements a Adversarial Network, i.e. a network of nodes
 * that will not behave honestly.<br><br>
 *
 * Change History<br>
 * ------------------------------------------------------------------------------------<br>
...
public class AdversarialNetwork extends Network
{
  // private variables
  private static final String cvsInfo = "$Id: AdversarialNetwork.java,v 1.3 2003/06/25 11:50:46 samjoseph Exp $";
  public static String getCvsInfo()
  {
    return cvsInfo;
  }

  private static Category o_cat = Category.getInstance(AdversarialNetwork.class.getName());  
  ...
  public static void init(String p_conf)
  {
    ...
    o_cat.info("AdversarialNetwork logging Initialized");
  }
